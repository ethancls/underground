		...
		if (selectedType && x < LARGEUR_PLATEAU && y < HAUTEUR_PLATEAU) {
			switch (selectedType) {
				...
				case 'bouton_rail_droite_vers_bas':
					...
					dessine_case(contexte, plateau, x, y);
					console.log("plateau.cases[" + x + "][" + y + "] = " + typeToString(plateau.cases[x][y]) + ";");
					break;
...
function cree_plateau_initial(plateau) {
	...
	plateau.cases[36][11] = Type_de_case.Rail_vertical;
	plateau.cases[36][12] = Type_de_case.Rail_droite_vers_haut;
	plateau.cases[7][12] = Type_de_case.Rail_droite_vers_bas; 
	plateau.cases[8][13] = Type_de_case.Rail_droite_vers_bas; 
	plateau.cases[9][15] = Type_de_case.Rail_droite_vers_bas; 
	plateau.cases[11][16] = Type_de_case.Rail_droite_vers_bas; 
	plateau.cases[17][17] = Type_de_case.Rail_droite_vers_bas; 
	plateau.cases[31][1] = Type_de_case.Rail_droite_vers_bas; 
	plateau.cases[35][3] = Type_de_case.Rail_droite_vers_bas; 
	plateau.cases[36][4] = Type_de_case.Rail_droite_vers_bas; 
	plateau.cases[34][2] = Type_de_case.Rail_droite_vers_bas; 
}
